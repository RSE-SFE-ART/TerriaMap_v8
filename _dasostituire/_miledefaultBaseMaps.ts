...
if (userLang === "it-IT" || userLang === "it") {
  var path_cookies = "https://www.rse-web.it/cookie/";
  
}

console.log("path cookies: " + path_cookies);
export function defaultBaseMaps(terria: Terria): any[] {
  ...
  baseMaps.push({
    item: {
      ...
      attribution:
        "© <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a>, © <a href='https://carto.com/about-carto'> CARTO </a>, <a href= '" + path_cookies + "'>  |  RSE Cookies</a> , <a href= {path_cookies}>  |  RSE Privacy</a>",
  ...
  baseMaps.push({
    item: {
      ...
      attribution:
      "© <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a>, © <a href='https://carto.com/about-carto'> CARTO </a>, <a href='" + path_cookies + "'>  |  RSE Cookies</a> , <a href='https://www.rse-web.it/privacy/'>  |  RSE Privacy</a>",
      subdomains: ["a", "b", "c", "d"],
      opacity: 1.0
    },
